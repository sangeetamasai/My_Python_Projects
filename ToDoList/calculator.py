...
def show(value):
    global equation
    equation+=value
    label_ans.config(text=equation)
def clear():
    global equation
    equation=''
    label_ans.config(text=equation)
...
def calculate():
    ...
    if equation!='':
        try:
            ...
            ans=playsound.playsound('welcome.mp3')
            equation=''
    label_ans.config(text=ans) 
label_ans=Label(root,width=25,height=2,text='',font=('arial',30))
label_ans.pack()
Button(root,text="C",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='teal',command=lambda:clear()).place(x=10,y=100)
Button(root,text="/",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='teal',command=lambda:show('/')).place(x=150,y=100)
Button(root,text="%",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='teal',command=lambda:show('%')).place(x=290,y=100)
Button(root,text="*",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='teal',command=lambda:show('*')).place(x=430,y=100)
...
Button(root,text="-",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='teal',command=lambda:show('-')).place(x=430,y=200)
...
Button(root,text="+",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='teal',command=lambda:show('+')).place(x=430,y=300)
...
Button(root,text="00",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='#2a2d36',command=lambda:show('00')).place(x=10,y=500)
Button(root,text="0",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='#2a2d36',command=lambda:show('0')).place(x=150,y=500)

Button(root,text=".",width=5,height=1,font=('arial',30,'bold'),bd=1,fg='#fff',bg='#2a2d36',command=lambda:show('.')).place(x=290,y=500)
Button(root,text="=",width=5,height=3,font=('arial',30,'bold'),bd=1,fg='#fff',bg='teal',command=lambda:calculate()).place(x=430,y=400)
